 ...
 * @author Shai Almog
 */
public class TweetappStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Tweetapp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TweetappStub());
    }
